...
function App() {
  ...
  return (
    <div className={`app-layout ${theme}`}>
      {/* LEFT ICON BAR - yang baru ditambah */}
      <div className="app-leftbar">
        <button className="app-leftbar-btn">
          <img src={EnvelopeIcon} alt="Profile" />
        </button>
        <button className="app-leftbar-btn">
          <img src={SearchIcon} alt="Settings" />
        </button>
        <button className="app-leftbar-btn">
          <img src={UsersIcon} alt="Communities" />
        </button>
        <button className="app-leftbar-btn">
          <img src={CameraIcon} alt="Status" />
        </button>
        <button className="app-leftbar-btn">
          <img src={BubbleDiscussionIcon} alt="Channels" />
        </button>
        <button className="app-leftbar-btn">
          <img src={UserAddIcon} alt="New Chat" />
        </button>
        <button className="app-leftbar-btn">
      ...
      <div className="app-main-wrapper">
        <header className="app-header">
          <div className="app-header-left">
            <h1 className="app-header-title">WhatsApp</h1>
          </div>
        ...
        <div className="app-sidebar-tabs">
          <button className="app-tab-btn active">All</button>
          <button className="app-tab-btn">Unread</button>
          <button className="app-tab-btn">Groups</button>
        </div>
        ...
        <div className="app-search-container">
          <div className="app-search-box">
            ...
            <input type="text" placeholder="Search or start new chat" className="app-search-input" />
          </div>
        </div>
